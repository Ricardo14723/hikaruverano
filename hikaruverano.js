...
<div class="download-container">
    ...
    <div class="series-header">
        ...
        <div class="series-info">
            <h1>Enlaces de Descarga - El verano en que Hikaru murió</h1>
            <p>Audio Japones</p>
        </div>
    </div>
        ...
        <div class="season-info">
            ...
            <div class="season-specs">
                <div class="season-spec">
                    ...
                    <div class="spec-value">Japones EAC3 5.1</div><div class="spec-value">Subs(Español-English)</div></div><div class="season-spec"><div class="spec-label">FORMATO</div>
        ...
        <div class="episodes-grid">
            <div class="episode-card">
                <div class="episode-header">
                    ...
                    <h3 class="episode-title">Episodios 1 y 2 (Sub Español)</h3>
                </div>
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">790 MB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~46 min
                      </div>
                    </div>
                </div>
                <a class="download-button" href="https://tpi.li/H1k4u1" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
